...
$game3 = $_SESSION['game3']; 
 ...
 <div class="title"><h2 align="center"><strong>The Laslett Hotel</strong></h2></div>
<button class="button" onClick="rewardsRedirect()">Rewards List</button>
      ...
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
		 ...
		 function calcRoute() {
              ...
              stop = new google.maps.LatLng(51.509162  , -0.195708)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.509150 , -0.196392)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.509429 , -0.196513)
                      waypts.push({
                          location:stop,
                          stopover:true});
             
              
			  //startpoint Notting Hill Gate
              start  = new google.maps.LatLng(51.509244, -0.195267);
              end = new google.maps.LatLng(51.50952600,  -0.19672500);
 ...
 var RMarker1 = new google.maps.Marker({
			title: 'Laslett Hotel Start Position',
          position: start,
		  icon: 'start.png',
          map: map,
		...
		google.maps.event.addListener(RMarker1, 'click', function() {
			...
			title: 'Game 1',
			icon: 'game.png',
          position: {lat:51.509162 , lng:-0.195708},
          map: map,
		...
		google.maps.event.addListener(RMarker2, 'click', function() {
			...
			title: 'Game 2',
			icon: 'game.png',
          position: {lat: 51.509150, lng: -0.196392},
          map: map,
		...
		google.maps.event.addListener(RMarker3, 'click', function() {
			...
			title: 'Game 3',
			icon: 'game.png',
          position: {lat: 51.509429, lng:-0.196513},
          map: map,
		...
		google.maps.event.addListener(RMarker4, 'click', function() {
			...
			title: 'The Laslett Hotel',
			icon: '5star.png',
          position: {lat: 51.509559, lng:-0.196564},
