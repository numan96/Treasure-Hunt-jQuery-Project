...
<?php	 
	...
	$hotelid = $_GET['hotelid'];
		$hotelname = $_GET['hotelname'];
		 ...
		 ?>
 <div class="title">
   <h2 align="center"><strong>Hotel Booking Form</strong></h2></div>
 
 
<br><br>
<form name="hotelbookingform" id="hotelbookingform" class="ui-field-contain">
 <input type="hidden" value="<?php echo $hotelid?>" id="hotelid">
 <input type="hidden" value="<?php echo $session_value?>" id="useremail">
 <br>
  <input type="hidden" value="250" id="total_value">
 
 <label class="ui-field-contain">Hotel Venue:</label>
 
 <input type="text" value="<?php echo $hotelname?>" id="hotelname" readonly>
 <br>
<!--Placeholder date-->
<label class="ui-field-contain">Start of stay:</label>

<input type="datetime" name="date"  id = "startdate" placeholder="YYYY-MM-DD hh:mm:ss" required autofocus>
<br>
<label class="ui-field-contain">End of stay:</label>
<input type="datetime" name="date" id="enddate" placeholder="YYYY-MM-DD hh:mm:ss" required autofocusrequired>
<!--Placeholder date-->
<br><br>

<label class="ui-field-contain">Guests :</label>
  <input type="number" name="Guests" min="1" max="10" placeholder="Minumum of 1 guest to a maxiumum of 10:" id="guests" required>
  
  
      <label class="ui-field-contain">Room Type:</label>
   
    <select id ="roomtypes" required>
      <option value="standard" >Standard (1-2 people)</option>
      <option value="family">Family (1-4 people)</option>
      <option value="luxury">Luxury (1-5 people)</option>
      <option value="penthouse">Penthouse (1-10 people)</option>
    </select>
         <br><br><br>
    <br> <br><br><br>
    <br>
...
<button type="button" class="button" name="submit" id="checkoutbtn" onClick="submitHotelForm()">Book Venue</button><br><br>
...
<script language='javascript'>
    ...
    var hotelid = $('#hotelid').val(); // define username variable
    
   var useremail = $('#useremail').val(); // define password variable
   var roomtypes = $('#roomtypes').val();
...
var startdate =  $('#startdate').val();
 ...
 var enddate =  $('#enddate').val();
    ...
    $.ajax({ // JQuery ajax function
      type: "POST", // Submitting Method
      url: "bookhotel.php", // PHP processor
      data:  'hotelid='+ hotelid + '&useremail=' + useremail + '&roomtypes=' + roomtypes + '&guestno=' + guestno + '&startdate=' + startdate + '&enddate=' + enddate,
