...
<meta charset="utf-8">
<title>Pub Booking Details</title>
...
<?php	 
	  ...
	  $pubbookingid = $_GET['pubbookingid'];
...
if (!$conn) {
    die("Connection failed: " . mysqli_connect_error());
	  ...
	  $sql = "SELECT pubbookingID, pubID, userID, pubbookingDate, pubguestNo, reservationtype FROM mobile_pubbookings";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
	  while($row = $result->fetch_assoc()) {
	if ($row["pubbookingID"] == $pubbookingid) { 
	
	?>
	
    
	<div align="center"><b><h2> <?php echo $pubname; ?> </b></h2>
    <br><br><br>
      You are booked for: <b><?php echo $row["pubbookingDate"]; ?></b>
      <br><br><br>
      <hr>
      <br><br><br>
      You have booked a table for: <b><?php echo $row["pubguestNo"]; ?>.</b>
       <br><br><br>
       <hr>
      <br><br><br>
