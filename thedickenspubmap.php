...
$game3 = $_SESSION['game3']; 
 ...
 <div class="title"><h2 align="center"><strong>The Dickens Pub</strong></h2></div>
...
<div id="map"></div>
      ...
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
		 ...
		 function calcRoute() {
              ...
              stop = new google.maps.LatLng(51.508203  , -0.073852)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.506621 , -0.074217)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.506207 , -0.071234)
                      waypts.push({
                          location:stop,
                          stopover:true});
              ...
              start  = new google.maps.LatLng(51.509679, -0.075611);
              end = new google.maps.LatLng(51.50674100, -0.0701710);
 ...
 var RMarker1 = new google.maps.Marker({
			title: 'The Dickens Inn Pub Start Position',
          position: start,
		  icon: 'start.png',
          map: map,
		...
		google.maps.event.addListener(RMarker1, 'click', function() {
			...
			title: 'Game 1',
			icon: 'game.png',
          position: {lat:51.508203 , lng:-0.073852},
          map: map,
		...
		google.maps.event.addListener(RMarker2, 'click', function() {
			...
			title: 'Game 2',
			icon: 'game.png',
          position: {lat: 51.506621, lng: -0.074217},
          map: map,
		...
		google.maps.event.addListener(RMarker3, 'click', function() {
			...
			title: 'Game 3',
			icon: 'game.png',
          position: {lat: 51.506207, lng:-0.071234},
          map: map,
