...
<meta charset="utf-8">
<title>Final Rewards List</title>
...
if ($result->num_rows > 0) {
 ...
 while($row = $result->fetch_assoc()) {
	 ...
	 $userspoints = $row["points"];
      ...
      <br>
      <br>
	 <div align="center"><b> You have earned a total of <?php echo $userspoints; ?> points. </b></div><br>
    <div align="center"><button class="button" onClick="treasureRedirect()">Back to Treasure Hunt Home</button></div>
