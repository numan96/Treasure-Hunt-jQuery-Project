...
<?php	 
	 ...
	 $game3 = $_SESSION['game3'];
		 ?></div>
 <div class="title"><h2 align="center"><strong>Pub Anagram</strong></h2></div>
...
function mygame(){
 	var myarray=[];
	var myArray = ['Uxbridge Arms', 'Crutched Friar', 'Rose and Crown', 'Queens Head', 'Dickens Inn'];
...
<body>
  ...
  <h3 align="center">
         Guess which pub venues from our site these are!
        </h3>
