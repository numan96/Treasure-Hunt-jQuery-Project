...
$game3 = $_SESSION['game3']; 
 ...
 <div class="title"><h2 align="center"><strong>Apex City of London Hotel</strong></h2></div>
...
<div id="map"></div>
      ...
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
		 ...
		 function calcRoute() {
              ...
              stop = new google.maps.LatLng(51.511040  , -0.079112)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.510917 , -0.079241)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.510663 , -0.079241)
                      waypts.push({
                          location:stop,
                          stopover:true});
              ...
              start  = new google.maps.LatLng(51.511234, -0.07835);
              end = new google.maps.LatLng(51.51046100, -0.07955000);
 ...
 var RMarker1 = new google.maps.Marker({
			title: 'Apex City Of London Hotel Start Position',
          position: start,
		  icon: 'start.png',
          map: map,
		...
		google.maps.event.addListener(RMarker1, 'click', function() {
			...
			title: 'Game 1',
			icon: 'game.png',
          position: {lat:51.511040 , lng:-0.079112},
          map: map,
		...
		google.maps.event.addListener(RMarker2, 'click', function() {
		 ...
		 window.open("hotelquiz.php","_self");
		//	window.open(" ","_self");
			...
			title: 'Game 2',
			icon: 'game.png',
          position: {lat: 51.510917, lng: -0.079241},
          map: map,
		...
		google.maps.event.addListener(RMarker3, 'click', function() {
		 ...
		 window.open("hotelmemory.php","_self");
			...
			title: 'Game 3',
			icon: 'game.png',
          position: {lat: 51.510663, lng:-0.079241},
          map: map,
		...
		google.maps.event.addListener(RMarker4, 'click', function() {
			...
			google.maps.event.addListener(RMarker4, 'dblclick', function() {
				window.open("hotelanagram.php","_self");
			});
			...
			icon: '5star.png',
          position: {lat: 51.510473, lng:-0.079364},
