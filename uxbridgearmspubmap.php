...
$game3 = $_SESSION['game3']; 
 ...
 <div class="title"><h2 align="center"><strong>The Uxbridge Arms</strong></h2></div>
<button class="button" onClick="rewardsRedirect()">Rewards List</button>
 ...
 var map;
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
          center: {lat: 51.50829300, lng: -0.19880300},
          zoom: 19
		 ...
		 function calcRoute() {
              ...
              stop = new google.maps.LatLng(51.508884  , -0.197341)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.508791 , -0.197952)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.508494 , -0.197746)
                      waypts.push({
                          location:stop,
                          stopover:true});
              ...
              start  = new google.maps.LatLng(51.508971, -0.196729);
              end = new google.maps.LatLng(51.50829300, -0.19880300);
 ...
 var RMarker1 = new google.maps.Marker({
		...
		google.maps.event.addListener(RMarker1, 'click', function() {
			...
			title: 'Game 1',
			icon: 'game.png',
          position: {lat:51.508884 , lng:-0.197341},
          map: map,
		...
		google.maps.event.addListener(RMarker2, 'click', function() {
			...
			title: 'Game 2',
			icon: 'game.png',
          position: {lat: 51.508791, lng: -0.197952},
          map: map,
		...
		google.maps.event.addListener(RMarker3, 'click', function() {
			...
			title: 'Game 3',
			icon: 'game.png',
          position: {lat: 51.508494, lng:-0.197746},
          map: map,
