...
if (!$conn) {
    die("Connection failed: " . mysqli_connect_error());
	  ...
	  $sql = "SELECT hotelID, hotelname, hotelLat, hotelLon, hotelDesc, hotelRating, hotelImg FROM mobile_hotels";
...
if ($result->num_rows > 0) {
    ...
    <br>
    <br>
     <div align="center"><img src="<?php echo $row["hotelImg"]; ?>" width="350" height="250"></div>
    </div>
