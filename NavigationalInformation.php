...
<meta charset="utf-8">
<title>Navigational Information</title>
...
<?php	 
		 ...
		 ?></div>
 <div class="title"><h2 align="center"><strong>Navigational Information</strong></h2></div>



<p align="center">
 Our application uses GPS recognition in correspondence with Google Maps allowing us to provide this service: Users must note:
 <br /><br /></p>
 
 <div align="center">
   <ol align="center">
     <li> Our maps may be updated spontaneously due to the use of Google Maps and Google having rights to the said software. </li>
     <br />
     <li> Our maps are well optimized, however in rare cases can be slightly inaccurate, however not by a large fraction. </li>
     <br />
     <li>Please ensure the use of your location service on your
       mobile device and ensure its correctly functioning as this can affect the user’s experience.</li>
     <br />
     <li> Finally please take your own safety and wellbeing into consideration when you’re on your mobile device and using our application as you will be       travelling a lot! </li>
     <br />
   </ol>
 </div>
 <ol align="center">
