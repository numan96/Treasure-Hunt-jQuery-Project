...
<div id="mySidenav" class="sidenav">
 ...
 <button type="button" class="button" onClick="contactRedirect()">Contact Us</button>
...
<div data-role="header" id="header" data-position="fixed" >
  ...
  <div align="center"> <span style="font-size:30px;cursor:pointer" onClick="openNav()"><img src="menu.jpg" width="26" height="21" align="middle" class="menuicon"></span><img src="imageedit_2_7868692569.png" width="170" height="60" align="middle"><span style="font-size:30px;cursor:pointer" onClick="homeRedirect()"><img src="home.png" alt="" width="41" height="34" align="middle"></span></div>
</div>
...
<div data-role="footer" id="footer" data-position="fixed">
  <div align="center"><a href="#" class="easyui-linkbutton" iconCls="icon-cancel"><img src="placeholder.png" width="69" height="69" padding="100" align="absmiddle" class="footer"></a>
    <a href="#" class="easyui-linkbutton" iconCls="icon-cancel"><img src="placeholder.png" width="69" height="69" padding="100" align="absmiddle" class="footer"></a>
    <a href="#" class="easyui-linkbutton" iconCls="icon-cancel"><img src="placeholder.png" width="69" height="69" padding="100" align="absmiddle" class="footer"></a><a href="#" class="easyui-linkbutton" iconCls="icon-cancel"><img src="placeholder.png" width="69" height="69" padding="100" align="absmiddle" class="footer"></a>
