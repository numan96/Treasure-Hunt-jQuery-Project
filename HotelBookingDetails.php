...
<?php	 
	  ...
	  $hotelbookingid = $_GET['hotelbookingid'];
...
if (!$conn) {
    die("Connection failed: " . mysqli_connect_error());
	  ...
	  $sql = "SELECT hotelbookingID, hotelID, userID, hotelbookingDate, hotelbookingtillDate, guestNo, roomtype FROM mobile_hotelbookings";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
	  while($row = $result->fetch_assoc()) {
	if ($row["hotelbookingID"] == $hotelbookingid) { 
	?>
	
    
<div align="center"><b><h2> <?php echo $hotelname; ?> </b></h2>
    <br><br><br>
     You are booked for: <b><?php echo $row["hotelbookingDate"]; ?></b>
      <br><br><br>
      <hr>
      <br><br><br>
     Until: <b><?php echo $row["hotelbookingtillDate"]; ?>.</b>
       <br><br><br>
       <hr>
      <br><br><br>
      In Room Type: <b><?php echo $row["roomtype"]; ?>.</b>
    <br><br><br>
     <hr>
      <br><br><br>
  You have booked a room for: <b><?php echo $row["guestNo"]; ?>.</b>
    <br><br><br>
