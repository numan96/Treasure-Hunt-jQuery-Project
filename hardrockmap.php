...
$game3 = $_SESSION['game3']; 
 ...
 <div class="title"><h2 align="center"><strong>Hard Rock Cafe</strong></h2></div>
...
<div id="map"></div>
      ...
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
		 ...
		 function calcRoute() {
              ...
              stop = new google.maps.LatLng(51.503166 , -0.151556)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.503407 , -0.150397)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.503540 , -0.149753)
                      waypts.push({
                          location:stop,
                          stopover:true});
              ...
              start  = new google.maps.LatLng(51.503033 , -0.152113);
              end = new google.maps.LatLng(51.50387600, -0.14911700);
 ...
 var RMarker1 = new google.maps.Marker({
			title: 'Hard Rock Cafe London Start Position',
          position: start,
		  icon: 'start.png',
          map: map,
		...
		google.maps.event.addListener(RMarker1, 'click', function() {
			...
			title: 'Game 1',
			icon: 'game.png',
          position: {lat:51.503166 , lng:-0.151556},
          map: map,
		...
		google.maps.event.addListener(RMarker2, 'click', function() {
			...
			title: 'Game 2',
			icon: 'game.png',
          position: {lat: 51.503407, lng:  -0.150397},
          map: map,
		...
		google.maps.event.addListener(RMarker3, 'click', function() {
			...
			title: 'Game 3',
			icon: 'game.png',
          position: {lat: 51.503540, lng: -0.149753},
          map: map,
