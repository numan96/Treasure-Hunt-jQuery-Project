...
<?php	 
	 ...
	 $game3 = $_SESSION['game3'];
		 ?></div>
 <div class="title"><h2 align="center"><strong>Hotel Slider</strong></h2></div>


 <script type="text/javascript">
	
		
	var puzzleImages = ['images/hotel1.jpg','images/hotel2.jpg','images/hotel3.jpg'];	// Array of images to choose from
	var rows = 3;
	var cols = 3;
	var points = 0;
