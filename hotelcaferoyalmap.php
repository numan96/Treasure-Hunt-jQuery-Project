...
<meta charset="utf-8">
<title>Hotel Cafe Royal TH</title>
...
$game3 = $_SESSION['game3']; 
 ...
 <div class="title"><h2 align="center"><strong>Hotel Cafe Royal</strong></h2></div>
...
<div id="map"></div>
      ...
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
		 ...
		 function calcRoute() {
              ...
              stop = new google.maps.LatLng(51.509866   , -0.134651)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.509960 , -0.135163)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.509806 , -0.13589)
                      waypts.push({
                          location:stop,
                          stopover:true});
             
              
			  //startpoint Piccadilly Circus
              start  = new google.maps.LatLng(51.509987, -0.134326);
              end = new google.maps.LatLng(51.51009200,  -0.13594300);
 ...
 var RMarker1 = new google.maps.Marker({
			title: 'Cafe Royal Hotel Start Position',
          position: start,
		  icon: 'start.png',
          map: map,
		...
		google.maps.event.addListener(RMarker1, 'click', function() {
			...
			title: 'Game 1',
			icon: 'game.png',
          position: {lat:51.509866 , lng:-0.134651},
          map: map,
		...
		google.maps.event.addListener(RMarker2, 'click', function() {
			...
			title: 'Game 2',
			icon: 'game.png',
          position: {lat: 51.509960, lng: -0.135163},
          map: map,
		...
		google.maps.event.addListener(RMarker3, 'click', function() {
			...
			title: 'Game 3',
			icon: 'game.png',
          position: {lat: 51.509806, lng:-0.13589},
          map: map,
		...
		google.maps.event.addListener(RMarker4, 'click', function() {
			...
			icon: '5star.png',
          position: {lat: 51.509988, lng:-0.135909},
