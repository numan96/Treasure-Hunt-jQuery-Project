...
<?php	 
	 ...
	 $game3 = $_SESSION['game3'];
		 ?></div>
 <div class="title"><h2 align="center"><strong>Restaurant Anagram</strong></h2></div>
...
function mygame(){
 	var myarray=[];
	var myArray = ['The Folly', 'Geales', 'Veeraswamy', 'Hard Rock Cafe', 'Mala Indian'];
...
<body>
  ...
  <h3 align="center">
         Guess which restaurant venues from our site these are!
        </h3>
