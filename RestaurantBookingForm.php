...
<?php	 
	...
	$restaurantid = $_GET['restaurantid'];
		$restaurantname = $_GET['restaurantname'];
		 ...
		 ?>
 <div class="title">
   <h2 align="center"><strong>Restaurant Booking Form</strong></h2></div>
 
 
<br><br>
<form name="restaurantbookingform"  id="restaurantbookingform" class="ui-field-contain">

<input type="hidden" value="<?php echo $restaurantid?>" id="restaurantid">
 <input type="hidden" value="<?php echo $session_value?>" id="useremail">
 <br>
 <label class="ui-field-contain">Restaurant Venue:</label>

 <input type="text" value="<?php echo $restaurantname?>" id="restaurantname" readonly>
 
  <input type="hidden" value="50" id="total_value">
...
<button type="button" class="button" name="submit" id="checkoutbtn" onClick="submitRestaurantForm()">Book Venue</button><br><br>
...
<script language='javascript'>
    ...
    var restaurantid = $('#restaurantid').val(); // define username variable
 ...
 var bookdate =  $('#bookdate').val();
    ...
    $.ajax({ // JQuery ajax function
      type: "POST", // Submitting Method
      url: "bookrestaurant.php", // PHP processor
      data:  'restaurantid='+ restaurantid + '&useremail=' + useremail + '&reservationtype=' + reservationtype + '&guestno=' + guestno + '&bookdate=' + bookdate,
	 ...
	 jQuery(function($) {
      var $form = $('#restaurantbookingform');
	 ...
	 $('#checkoutbtn').on('click', function(e) {
        ...
        handler.open({
          name: 'GHunt Booking',
          currency: 'gbp',
          description: $('#restaurantname').val(),
