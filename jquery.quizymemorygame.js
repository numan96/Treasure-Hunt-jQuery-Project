...
(function($) {
      ...
      init : function(options) {
          ...
          // if it's the second click out of two (turning the second card)
            ...
            if(tClass == selItemClass){
              ...
              if(numMatches == itemsNum/2){
				  ...
				  if (numTotalClicks < 10) {
					  
					  Points = 50;
					  }
					 else if (numTotalClicks > 10 < 15) {
						  
						  Points = 30; 
						  }
				    else if (numTotalClicks > 15 < 20) {
						
						Points = 15;
						}
					  else if (numTotalClicks > 20) {
						
						Points = 5;
						}	
						$(scoredisplay).html(Points);
                // removes the timer
                ...
                if(opts.gameSummary){
                  ...
                  $('div#quizy-game-summary').
                      ...
                      html(Points+'<br>'+opts.textSummaryPoints);
        ...
        if(opts.gameSummary){
          ...
          gameEl.append('<div id="quizy-game-summary"><div class="gs-column" id="gs-column1">'+
                          ...
                          '<div class="gs-column" id="gs-column3"></div>'+'<div class="gs-column" id="gs-column4"></div>'+
  ...
  ****************************************************************************/
  ...
  $.fn.quizyMemoryGame.defaults = {itemWidth: 90, itemHeight: 90, itemsMargin:10, colCount:4, animType:'scroll', animSpeed:250, openDelay:2500, flipAnim:'rl', resultIcons:true, gameSummary:true, randomised:true, textSummaryTitle:'Your game summary', replayButton:true, replayButtonText:'Replay', closeButtonText:'Close', textSummaryClicks:'clicks', textSummaryTime:'seconds', textSummaryPoints:'points', onFinishCall:''}
