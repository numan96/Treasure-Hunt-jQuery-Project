...
<meta charset="utf-8">
<title>Restaurant Booking Details</title>
...
<?php	 
	  ...
	  $restaurantbookingid = $_GET['restaurantbookingid'];
...
if (!$conn) {
    die("Connection failed: " . mysqli_connect_error());
	  ...
	  $sql = "SELECT restaurantbookingID, restaurantID, userID, restaurantbookingDate, restaurantguestNo, reservationtype FROM mobile_restaurantbookings";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
	  while($row = $result->fetch_assoc()) {
	if ($row["restaurantbookingID"] == $restaurantbookingid) { 
	
	?>
	
    
	<div align="center"><b><h2> <?php echo $restaurantname; ?> </b></h2>
    <br><br><br>
      You are booked for: <b><?php echo $row["restaurantbookingDate"]; ?></b>
      <br><br><br>
      <hr>
      <br><br><br>
      You have booked a table for: <b><?php echo $row["restaurantguestNo"]; ?>.</b>
       <br><br><br>
       <hr>
      <br><br><br>
      Reservation Type: <b><?php echo $row["reservationtype"]; ?>.</b>
    <br><br><br>
    
    <button type="button" class="button" onClick="window.location.href='bookings.php'">Back to Bookings</button>
    </div>
