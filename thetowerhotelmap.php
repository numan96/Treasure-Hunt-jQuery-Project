...
<meta charset="utf-8">
<title>The Tower Hotel TH</title>
...
$game3 = $_SESSION['game3']; 
 ...
 <div class="title"><h2 align="center"><strong>The Tower Hotel</strong></h2></div>
...
<div id="map"></div>
      ...
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
		 ...
		 function calcRoute() {
              ...
              stop = new google.maps.LatLng(51.508786   , -0.073632)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.507348 , -0.074034)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.506353 , -0.073337)
                      waypts.push({
                          location:stop,
                          stopover:true});
             
              
			  //startpoint Tower Hill
              start  = new google.maps.LatLng(51.509699, -0.07588);
              end = new google.maps.LatLng(51.50662030,  -0.07277920);
 ...
 var RMarker1 = new google.maps.Marker({
			title: 'The Tower Hotel Start Position',
          position: start,
		  icon: 'start.png',
          map: map,
		...
		google.maps.event.addListener(RMarker1, 'click', function() {
			...
			title: 'Game 1',
			icon: 'game.png',
          position: {lat:51.508786 , lng:-0.073632},
          map: map,
		...
		google.maps.event.addListener(RMarker2, 'click', function() {
			...
			title: 'Game 2',
			icon: 'game.png',
          position: {lat: 51.507348, lng: -0.074034},
          map: map,
		...
		google.maps.event.addListener(RMarker3, 'click', function() {
			...
			title: 'Game 3',
			icon: 'game.png',
          position: {lat: 51.506353, lng:-0.073337},
          map: map,
		...
		google.maps.event.addListener(RMarker4, 'click', function() {
			...
			icon: '5star.png',
          position: {lat: 51.506626, lng: -0.072784},
