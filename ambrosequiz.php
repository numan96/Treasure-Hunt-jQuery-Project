...
<?php	 
	 ...
	 $game2 = $_SESSION['game2'];
		 ?></div>
 <div class="title"><h2 align="center"><strong>Quiz</strong></h2></div>
    ...
    <div id="pub-memorygame" class="quizy-memorygame">
      <ul>
          ...
          <li class="match1">
            <br><br><br><p class="text-style1">Brandy</p>
          </li>
          <li class="match2">
            <br><br><br><p class="text-style1">Wine</p>
          </li>
          <li class="match3">
            <br><br><br><p class="text-style1">Beer</p>
          </li>
          <li class="match4">
            <br><br><br><p class="text-style1">Martini</p>
          </li>
