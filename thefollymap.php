...
$game3 = $_SESSION['game3']; 
 ...
 <div class="title"><h2 align="center"><strong>The Folly</strong></h2></div>
<button class="button" onClick="rewardsRedirect()">Rewards List</button>
 ...
 var map;
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
           position: {lat: 51.51613060, lng: -0.08095443},
          zoom: 19
		 ...
		 function calcRoute() {
              ...
              stop = new google.maps.LatLng(51.510427 , -0.080364)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.510407 , -0.08266)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.510721 , -0.085117)
                      waypts.push({
                          location:stop,
                          stopover:true});
              ...
              start  = new google.maps.LatLng(51.511215 , -0.078337);
              end = new google.maps.LatLng(51.511185 , -0.085872);
 ...
 var RMarker1 = new google.maps.Marker({
			title: 'The  Folly Restaurant Start Position',
          position: start,
		  icon: 'start.png',
          map: map,
		...
		google.maps.event.addListener(RMarker1, 'click', function() {
			...
			title: 'Game 1',
			icon: 'game.png',
          position: {lat:51.510427 , lng:-0.080364},
          map: map,
		...
		google.maps.event.addListener(RMarker2, 'click', function() {
			...
			title: 'Game 2',
			icon: 'game.png',
          position: {lat: 51.510407, lng: -0.08266},
          map: map,
		...
		google.maps.event.addListener(RMarker3, 'click', function() {
			...
			title: 'Game 3',
			icon: 'game.png',
          position: {lat: 51.510721, lng:-0.085117},
          map: map,
