...
$game3 = $_SESSION['game3']; 
 ...
 <div class="title"><h2 align="center"><strong>Crutched Friar Bar</strong></h2></div>
...
<div id="map"></div>
 ...
 var map;
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
          center: {lat: 51.51118000, lng: -0.07887200},
          zoom: 19
		 ...
		 function calcRoute() {
              ...
              stop = new google.maps.LatLng(51.511311  , -0.077991)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.511211 , -0.078296)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.511164 , -0.078677)
                      waypts.push({
                          location:stop,
                          stopover:true});
              ...
              start  = new google.maps.LatLng(51.511364, -0.077814);
              end = new google.maps.LatLng(51.51118000, -0.07887200);
 ...
 var RMarker1 = new google.maps.Marker({
			title: 'Crutched Friar Start Position',
          position: start,
		  icon: 'start.png',
          map: map,
		...
		google.maps.event.addListener(RMarker1, 'click', function() {
			...
			title: 'Game 1',
			icon: 'game.png',
          position: {lat:51.511311 , lng:-0.077991},
          map: map,
		...
		google.maps.event.addListener(RMarker2, 'click', function() {
			...
			title: 'Game 2',
			icon: 'game.png',
          position: {lat: 51.511211, lng: -0.078296},
          map: map,
		...
		window.open("pubmemory.php","_self");
			});
		<?php if ($game2 == 1){ ?>
			...
			title: 'Game 3',
			icon: 'game.png',
          position: {lat: 51.511164, lng:-0.078677},
          map: map,
		...
		google.maps.event.addListener(RMarker4, 'click', function() {
			...
			google.maps.event.addListener(RMarker4, 'dblclick', function() {
				window.open("pubanagram.php","_self");
			});
			<?php if ($game3 == 1){ ?>
			...
			title: 'Crutched Friar',
			icon: 'pub2.png',
          position: {lat: 51.511200, lng:-0.078862},
