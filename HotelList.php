...
?>
<br><br>
<input type="text" id="myInput" onKeyUp="searchHotels()" placeholder="Search for hotel.."> 
<br>
<table id="hotelTable"><tr class="header"><th style="width:90%;" align="center">Hotel Name</th><th></th></tr>
<?php
     // output data of each row
     while($row = $result->fetch_assoc()) {
     
		 echo "<tr><td align='center'>" . $row["hotelname"]. "</td>";

?> <td><button type="button" class="button" onClick="window.location.href='HotelDetails.php?hotelid=<?php echo $row['hotelID']; ?>'">View Venue</button></td></tr>
<?php
     }
     echo "</table>";
} else {
     echo "0 hotels available";
}
