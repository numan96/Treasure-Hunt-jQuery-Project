...
$game3 = $_SESSION['game3']; 
 ...
 <div class="title"><h2 align="center"><strong>Rose and Crown</strong></h2></div>
...
<div id="map"></div>
      ...
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
		 ...
		 function calcRoute() {
              ...
              stop = new google.maps.LatLng(51.503150  , -0.151725)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.503699 , -0.149339)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.503818 , -0.149042)
                      waypts.push({
                          location:stop,
                          stopover:true});
              ...
              start  = new google.maps.LatLng(51.503057, -0.152299);
              end = new google.maps.LatLng(51.50407100, -0.14901400);
 ...
 var RMarker1 = new google.maps.Marker({
			title: 'The Rose & Crown Pub Start Position',
          position: start,
		  icon: 'start.png',
          map: map,
		...
		google.maps.event.addListener(RMarker1, 'click', function() {
			...
			title: 'Game 1',
			icon: 'game.png',
          position: {lat:51.503150 , lng:-0.151725},
          map: map,
		...
		google.maps.event.addListener(RMarker2, 'click', function() {
			...
			title: 'Game 2',
			icon: 'game.png',
          position: {lat: 51.503699, lng: -0.149339},
          map: map,
		...
		window.open("pubmemory.php","_self");
			...
			title: 'Game 3',
			icon: 'game.png',
          position: {lat: 51.503818, lng:-0.149042},
          map: map,
