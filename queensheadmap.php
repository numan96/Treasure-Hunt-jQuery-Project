...
$game3 = $_SESSION['game3']; 
 ...
 <div class="title"><h2 align="center"><strong>The Queens Head</strong></h2></div>
...
<div id="map"></div>
      ...
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
		 ...
		 function calcRoute() {
              ...
              stop = new google.maps.LatLng(51.510327  , -0.135038)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.510539 , -0.13537)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.510716 , -0.135466)
                      waypts.push({
                          location:stop,
                          stopover:true});
              ...
              start  = new google.maps.LatLng(51.510040, -0.134545);
              end = new google.maps.LatLng(51.51081400, -0.13539800);
 ...
 var RMarker1 = new google.maps.Marker({
			title: 'The Queens Head Pub Start Position',
          position: start,
		  icon: 'start.png',
          map: map,
		...
		google.maps.event.addListener(RMarker1, 'click', function() {
			...
			title: 'Game 1',
			icon: 'game.png',
          position: {lat:51.510327 , lng:-0.135038},
          map: map,
		...
		google.maps.event.addListener(RMarker2, 'click', function() {
			...
			title: 'Game 2',
			icon: 'game.png',
          position: {lat: 51.510539, lng: -0.13537},
          map: map,
		...
		google.maps.event.addListener(RMarker3, 'click', function() {
			...
			title: 'Game 3',
			icon: 'game.png',
          position: {lat: 51.510716, lng:-0.135466},
          map: map,
