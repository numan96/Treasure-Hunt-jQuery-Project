...
<meta charset="utf-8">
<title>Restaurant Memory Game</title>
...
<?php	 
	 ...
	 $game2 = $_SESSION['game2'];
		 ?></div>
 <div class="title"><h2 align="center"><strong>Restaurant Memory</strong></h2></div>
    ...
    <div id="pub-memorygame" class="quizy-memorygame">
      <ul>
          <li class="match1">
            <img src="malaindian.jpg">
          </li>
          <li class="match2">
            <img src="geales.jpg">
          </li>
          <li class="match3">
            <img src="veeraswamy.jpg">
          </li>
          <li class="match4">
            <img src="hardrock.jpg">
          </li>
          
          <li class="match1">
            <br><br><br><p class="text-style1">Mala Indian</p>
          </li>
          <li class="match2">
            <br><br><br><p class="text-style1">Geales</p>
          </li>
          <li class="match3">
            <br><br><br><p class="text-style1">Veeraswamy</p>
          </li>
          <li class="match4">
            <br><br><br><p class="text-style1">Hard Rock</p>
          </li>
