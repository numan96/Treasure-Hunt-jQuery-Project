...
<?php	 
	 ...
	 $game2 = $_SESSION['game2'];
		 ?></div>
 <div class="title"><h2 align="center"><strong>Hotel Memory</strong></h2></div>
    ...
    <div id="pub-memorygame" class="quizy-memorygame">
      <ul>
          <li class="match1">
            <img src="apexcity.jpg">
          </li>
          <li class="match2">
            <img src="londonhilton.jpg">
          </li>
          <li class="match3">
            <img src="thelaslett.jpg">
          </li>
          <li class="match4">
            <img src="thetower.jpg">
          </li>
          
          <li class="match1">
            <br><br><br><p class="text-style1">Apex</p>
          </li>
          <li class="match2">
            <br><br><br><p class="text-style1">The Hilton</p>
          </li>
          <li class="match3">
            <br><br><br><p class="text-style1">Laslett</p>
          </li>
          <li class="match4">
            <br><br><br><p class="text-style1">Tower</p>
          </li>
