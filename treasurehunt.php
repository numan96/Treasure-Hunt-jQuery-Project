...
function closeNav() {
  ...
  document.getElementById("main").style.marginLeft = "0px";
	...
	function startlocationRedirect() {
      window.location.href = "startlocation.php";
    } 
...
<?php	 
		 ...
		 ?></div>
 <div class="title"><h2 align="center"><strong>Treasure Hunt</strong></h2></div>
 <?php if (!empty($_SESSION['username'])) { ?>
 
 
 <button class="button" onClick="startlocationRedirect()">Start Treasure Hunt</button>
 
 <?php } else if (empty($_SESSION['username'])){?>
 
<div align="center"> <b> Please login to play the Treasure Hunt! </b></div>
 <?php } ?>

<div align="center"><p>Below is a video explaining details of how to play the treasure hunt game. Playing the treasure hunt, allows you to win vouchers and rewards for your favourite venues from free drinks to free stays at a 5 star hotel such as Apex City of London Hotel.</p></div>

 <div align="center"><div class="video-container"><iframe src="gameintroduction.mp4" type="video/mp4">
