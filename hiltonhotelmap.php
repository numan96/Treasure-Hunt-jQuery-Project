...
$game3 = $_SESSION['game3']; 
 ...
 <div class="title"><h2 align="center"><strong>Hilton Hotel On Park Lane</strong></h2></div>
<button class="button" onClick="rewardsRedirect()">Rewards List</button>
      ...
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
		 ...
		 function calcRoute() {
              ...
              stop = new google.maps.LatLng(51.503816   , -0.148847)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.504424 , -0.149458)
                      waypts.push({
                          location:stop,
                          stopover:true});
              stop = new google.maps.LatLng(51.504904 , -0.150155)
                      waypts.push({
                          location:stop,
                          stopover:true});
              ...
              start  = new google.maps.LatLng(51.503034, -0.152258);
              end = new google.maps.LatLng(51.50543700,  -0.15039100);
 ...
 var RMarker1 = new google.maps.Marker({
			title: 'Hilton Hotel On Park Lane Start Position',
          position: start,
		  icon: 'start.png',
          map: map,
		...
		google.maps.event.addListener(RMarker1, 'click', function() {
			...
			title: 'Game 1',
			icon: 'game.png',
          position: {lat:51.503816 , lng:-0.148847},
          map: map,
		...
		google.maps.event.addListener(RMarker2, 'click', function() {
			...
			title: 'Game 2',
			icon: 'game.png',
          position: {lat: 51.504424, lng: -0.149458},
          map: map,
		...
		google.maps.event.addListener(RMarker3, 'click', function() {
			...
			title: 'Game 3',
			icon: 'game.png',
          position: {lat: 51.504904, lng:-0.150155},
          map: map,
		...
		google.maps.event.addListener(RMarker4, 'click', function() {
			...
			title: 'London Hilton On Park Lane',
			icon: '4star.png',
          position: {lat: 51.505530, lng:-0.150429},
